...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/subwayLine/banpo.css">
</head>
  ...
  <main>
    ...
    <div class="station_info">
      ...
      <div class="station_img">
        <img src="${pageContext.request.contextPath}/assets/img/subwayLine/banpo.png" alt="">
      </div>
    ...
    <div class="map_api">
			<div id="map" style="width: 100%; height: 400px;" data-lat="${lat}"
				data-lng="${lng}" data-name="반포역"></div>
