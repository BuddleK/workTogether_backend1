...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/subwayLine/nonehyune.css">
</head>
  ...
  <main>
    ...
    <div class="station_info">
      ...
      <div class="station_img">
        <img src="${pageContext.request.contextPath}/assets/img/subwayLine/nonehyune.png" alt="">
      </div>
