...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/subwayLine/nonehyune.css">
</head>
	...
	<main>
		...
		<div class="station_info">
			...
			<div class="station_img">
				<img
					src="${pageContext.request.contextPath}/assets/img/subwayLine/nonehyune.png"
					alt="">
			</div>
			...
			<div class="line_number">
				<img
					...
					alt=""> <img
					src="${pageContext.request.contextPath}/assets/img/subwayLine/dx_Line.png"
					alt="">
			</div>
		</div>
		...
		<div class="map_api">
			<div id="map" style="width: 100%; height: 400px;" data-lat="${lat}"
				data-lng="${lng}" data-name="논현역"></div>
