...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/subwayLine/gosukterminner.css">
</head>
	...
	<main>
		...
		<div class="station_info">
			...
			<div class="station_img">
				<img
					src="${pageContext.request.contextPath}/assets/img/subwayLine/gosukterminner.png"
					alt="">
			</div>
			...
			<div class="line_number">
				<img
					src="${pageContext.request.contextPath}/assets/img/subwayLine/LIne_3.png"
					alt=""> <img
					src="${pageContext.request.contextPath}/assets/img/subwayLine/Line_7.png"
					alt=""> <img
					src="${pageContext.request.contextPath}/assets/img/subwayLine/Line_9.png"
					alt="">
			</div>
		</div>
		...
		<div class="map_api">
			<div id="map" style="width: 100%; height: 400px;" data-lat="${lat}"
				data-lng="${lng}" data-name="고속터미널역"></div>
