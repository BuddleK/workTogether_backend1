...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/subwayLine/gangnam.css">
</head>
	...
	<main>
		...
		<div class="station_info">
			...
			<div class="station_img">
				<img
					src="${pageContext.request.contextPath}/assets/img/subwayLine/gangnam.png"
					alt="">
			</div>
			...
			<div class="line_number">
				<img
					src="${pageContext.request.contextPath}/assets/img/subwayLine/Line_2.png"
					alt=""> <img
		...
		<div class="map_api">
			<div id="map" style="width: 100%; height: 400px;" data-lat="${lat}"
				data-lng="${lng}" data-name="강남역"></div>
