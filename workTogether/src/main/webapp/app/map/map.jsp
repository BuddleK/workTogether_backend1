...
<head>
  ...
  <script defer src="./../../assets/js/map/map.js"></script>
</head>
...
<body>
  ...
  <main>
    ...
    <div class="map_container">
      <!-- 지도 api 칸 -->
      <div class="map_api"><img class="map_img" src="./../../assets/img/map/mapImg.png" alt="지도그림">
        ...
        <div class="map_info">
          ...
          <div class="info_content_container">
            ...
            <ul class="info_content">
              ...
              <!-- 지역 주소 -->
              <li class="info_address"><img src="./../../assets/img/map/mapmarker.png" alt=""> 서울 강남구 논현로 94길 7 2층</li>
              <br>
              <!-- 오픈 시간 -->
              <li class="info_times"><img src="./../../assets/img/map/clock.png" alt=""> 01:30에 라스트 오더<br>
                <strong>&emsp;&emsp; 매일 : 09:20 ~ 02:00<br>
                  &emsp; &emsp; 01:30 라스트 오더</strong>
              </li><br>
              <!-- 장소 전화번호 -->
              <li class="info_phonenum"><img src="./../../assets/img/map/call.png" alt=""> 0507-1350-6769</li><br>
              <!-- 장소 상세(인터넷 유무, 배달 유무 등등...) -->
              <li class="info_detail"><img src="./../../assets/img/map/market.png" alt=""> 배달, 포장, 무선 인터넷,
                <br>&emsp;&emsp; 반려동물, 동반
              </li>
              <!-- 찜 버튼 -->
              <li id="wishbtn"><img src="./../../assets/img/map/star.png" alt=""> 찜버튼</li>
            </ul>
          </div>
        </div>
        <!-- 장소 상세설명 -->
