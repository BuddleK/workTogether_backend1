...
<body>
  ...
  <main>
    <section class="sign">
      <form action="${pageContext.request.contextPath}/users/joinNormalOk.us" method="post" class="sign_form">
        <!-- 공통 users -->
        <input type="hidden" name="usersType" value="N"/>

        <div class="sign_box sign_title"><p>일반 회원가입</p></div>

        <div class="sign_box sign_id">
          <p>아이디</p>
          <input type="text" id="get_id_input" name="usersId" placeholder="8자리 이상, 문자 숫자 포함" required>
        ...
        <div class="sign_box sign_password">
          <p>비밀번호</p>
          <input type="password" name="usersPassword" placeholder="비밀번호 8자리 입력(숫자와 영어 특수기호 포함)" id="pw_input" required>
        </div>
        ...
        <div class="sign_box sign_birth">
          <p>휴대전화</p>
          <input type="text" id="phone" name="usersPhone" placeholder="- 없이 숫자만 입력해주세요." required>
        </div>
        ...
        <div class="section_normal">
          <div class="sign_box sign_level">
            <label for="level1">
              <input type="radio" id="level1" name="normalUsersLevel" value="1">보행 가능(계단 사용 가능) [1레벨]
            </label>
            <label for="level2">
              <input type="radio" id="level2" name="normalUsersLevel" value="2">보행 가능(계단 사용 불가능) [2레벨]
            </label>
            <label for="level3">
              <input type="radio" id="level3" name="normalUsersLevel" value="3">보행 가능(휠체어 사용) [3레벨]
            </label>
            <label for="level4">
              <input type="radio" id="level4" name="normalUsersLevel" value="4">보행 가능(휠체어 없음) [4레벨]
            </label>
          </div>
        </div>
