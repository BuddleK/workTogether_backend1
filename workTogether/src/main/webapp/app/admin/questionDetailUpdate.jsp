...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/assets/css/admin/questionDetailUpdate.css"
    />
    ...
    <script
      defer
      src="${pageContext.request.contextPath}/assets/js/admin/questionDetailUpdate.js"
    ></script>
