...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/userDetail.css" />
    ...
    <script defer src="${pageContext.request.contextPath}/assets/js/modal/modalPointChargeLog.js"></script>
