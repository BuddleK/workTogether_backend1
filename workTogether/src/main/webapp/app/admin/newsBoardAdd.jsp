...
<head>
  ...
  <script defer src="${pageContext.request.contextPath}/assets/js/modal/modalAddNewsFinished.js"></script>
</head>
<body>
    ...
    <section class="add_section">
      ...
      <form id="write-form"
        ...
        <div class="add_content">
          ...
          <textarea name="content" id="news" placeholder="요약할 뉴스를 작성해주세요" required></textarea>
        </div>

        <div class="add_link">
          <div class="add_link_title">뉴스 링크</div>
          <input type="text" name="link" class="link_input" placeholder="http://example.com" />
        </div>
  ...
  <script src="${pageContext.request.contextPath}/assets/js/admin/newsBoard.js"></script>
</body>
</html>
