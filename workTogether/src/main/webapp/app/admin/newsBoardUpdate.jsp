        ...
        <section class="add_section">
          <div class="add_data">
            ...
            <input
              ...
              name="newsTitle"
              class="title_content"
              value="<c:out value='${news.newsTitle}'/>"
            ...
            <div class="name_content">
              <c:choose>
                <c:when test="${not empty news.adminName}"><c:out value="${news.adminName}"/></c:when>
                <c:otherwise>관리자 #<c:out value="${news.adminNumber}"/></c:otherwise>
              </c:choose>
            </div>

            <div class="date">작성 날짜</div>
            <div class="date_content"><c:out value="${news.newsCreatedDate}"/></div>
          </div>

          <div class="add_content">
            <div class="board_option"></div>
            <!-- 내용 입력 -->
            <textarea name="newsContent" id="news" placeholder="내용을 입력하세요." required><c:out value="${news.newsContent}"/></textarea>
          </div>
          ...
          <div class="add_link">
            ...
            <input
              ...
              name="newsLinkUrl"
              class="link_input"
              value="<c:out value='${news.newsLinkUrl}'/>"
