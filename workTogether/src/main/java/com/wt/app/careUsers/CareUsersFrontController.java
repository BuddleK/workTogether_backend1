...
import com.wt.app.user.NormalJoinOkController;

/**
 * Servlet implementation class AdminFrontController
 */
public class CareUsersFrontController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CareUsersFrontController() {
        super();
