...
public class NormalMsgListJsOkController implements Execute {
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		dao.selectAllReceive(pageMap).stream().map(gson::toJson).map(JsonParser::parseString).forEach(msgs::add);
