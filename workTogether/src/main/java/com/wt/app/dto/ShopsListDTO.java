...
public class ShopsListDTO {
	...
	private double shopsLatitude;
	private double shopsLongitude;
	private String shopsPhone;
	private String shopsWorkingHours;
	private String shopsFloor1f;
	private String shopsRamp;
	private String shopsEntranceStep;
	private String shopsEntranceThreshold;
	private String shopsToiletStep;
	private String shopsToiletThreshold;
	private String shopsDisabledToilet;
	...
	public double getShopsLatitude() {
		return shopsLatitude;
	}

	public void setShopsLatitude(double shopsLatitude) {
		this.shopsLatitude = shopsLatitude;
	}

	public double getShopsLongitude() {
		return shopsLongitude;
	}

	public void setShopsLongitude(double shopsLongitude) {
	...
	public String getShopsFloor1f() {
		return shopsFloor1f;
	}

	public void setShopsFloor1f(String shopsFloor1f) {
	...
	public String getShopsEntranceStep() {
		return shopsEntranceStep;
	}

	public void setShopsEntranceStep(String shopsEntranceStep) {
		this.shopsEntranceStep = shopsEntranceStep;
	}

	public String getShopsEntranceThreshold() {
	...
	public void setShopsToiletStep(String shopsToiletStep) {
		this.shopsToiletStep = shopsToiletStep;
	}

	public String getShopsToiletThreshold() {
		return shopsToiletThreshold;
	}

	public void setShopsToiletThreshold(String shopsToiletThreshold) {
		this.shopsToiletThreshold = shopsToiletThreshold;
	}

	public String getShopsDisabledToilet() {
		return shopsDisabledToilet;
	}

	public void setShopsDisabledToilet(String shopsDisabledToilet) {
		this.shopsDisabledToilet = shopsDisabledToilet;
	}

	public String getShopsElevator() {
		return shopsElevator;
	}

	public void setShopsElevator(String shopsElevator) {
		this.shopsElevator = shopsElevator;
	}

	public String getShopsParking() {
		return shopsParking;
	}
	...
	public void setShopsDisabledParking(String shopsDisabledParking) {
	...
	public String toString() {
		return "ShopsListDTO [shopsNumber=" + shopsNumber + ", shopsName=" + shopsName + ", shopsBranchName="
				...
				+ ", shopsRamp=" + shopsRamp + ", shopsEntranceStep=" + shopsEntranceStep + ", shopsEntranceThreshold="
				+ shopsEntranceThreshold + ", shopsToiletStep=" + shopsToiletStep + ", shopsToiletThreshold="
